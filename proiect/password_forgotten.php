...
<style type="text/css">
.ie6_png 			{behavior: url("iepngfix.htc"/*tpa=http://osc3.template-help.com/osc_23506/iepngfix.htc*/) }
.ie6_png img		{behavior: url("iepngfix.htc"/*tpa=http://osc3.template-help.com/osc_23506/iepngfix.htc*/) }
.ie6_png input		{behavior: url("iepngfix.htc"/*tpa=http://osc3.template-help.com/osc_23506/iepngfix.htc*/) }
</style>
<!--[if IE]>
...
<tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:148px;">
		<tr><td><b>Currencies:</b><form name="currencies" action="http://osc3.template-help.com/osc_23506/password_forgotten.php" method="get"><select name="currency" onChange="this.form.submit();" class="select"><option value="USD" SELECTED>US Dollar</option><option value="EUR">Euro</option></select><input type="hidden" name="language" value="en"></form></td>
		</tr>
	</table>
											</td>
									...
									<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:107px">
										<tr><td><b>&nbsp;&nbsp;Language:</b><a href="password_forgotten.php-language=en.htm" tppabs="http://osc3.template-help.com/osc_23506/password_forgotten.php?language=en"><img src="includes/languages/english/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/english/images/icon.gif" border="0" alt="English" title=" English " width="24" height="15"></a><img src="images/flag_sep2.gif" tppabs="http://osc3.template-help.com/osc_23506/images/flag_sep2.gif" border="0" alt="" width="1" height="10"  style="margin:0px 8px 0px 8px;"><a href="password_forgotten.php-language=de.htm" tppabs="http://osc3.template-help.com/osc_23506/password_forgotten.php?language=de"><img src="includes/languages/german/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/german/images/icon.gif" border="0" alt="Deutsch" title=" Deutsch " width="24" height="15"></a><img src="images/flag_sep2.gif" tppabs="http://osc3.template-help.com/osc_23506/images/flag_sep2.gif" border="0" alt="" width="1" height="10"  style="margin:0px 8px 0px 8px;"><a href="password_forgotten.php-language=es.htm" tppabs="http://osc3.template-help.com/osc_23506/password_forgotten.php?language=es"><img src="includes/languages/espanol/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/espanol/images/icon.gif" border="0" alt="Espa&ntilde;ol" title=" Espa&ntilde;ol " width="24" height="15"></a></td>
										</tr>
									</table>
											</td>
											<td><img src="images/part.gif" tppabs="http://osc3.template-help.com/osc_23506/images/part.gif" border="0" alt="" width="1" height="34"></td>
...
<table cellpadding="0" cellspacing="0" border="0" align="center" style="width:140px;">
	<tr>
		<td class="z1"><strong>Shopping Cart:</strong><span> now in your cart </span><a href="shopping_cart.php.htm" tppabs="http://osc3.template-help.com/osc_23506/shopping_cart.php">87  items</a></td>
	</tr>
</table>
											</td>										
										</tr>
...
<table cellpadding="0" cellspacing="0" border="0" class="menu">
					<tr><td class="td">
						<table cellpadding="0" cellspacing="0" border="0" class="table">
							...
							<td id="over_m4" onMouseOut="this.id='over_m4';" onMouseOver="this.id='over_m4';" onClick="document.location='create_account.php.htm'/*tpa=http://osc3.template-help.com/osc_23506/create_account.php*/" nowrap="nowrap">Create an Account</td>
							<td class="menu_separator"><img src="images/menu_separator.gif" tppabs="http://osc3.template-help.com/osc_23506/images/menu_separator.gif" border="0" alt="" width="1" height="38"></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0"  class="infoBox3_table">
  ...
  <tr>
    <td  class="boxText">
					...
					<div class="pic2_l">
						<div class="pic2_tl">
							<div class="pic2_tr">
								<div class="pic2_bl">
									<div class="pic2_br">
										<div class="width_100"><a href="product_info.php-products_id=64.htm" tppabs="http://osc3.template-help.com/osc_23506/product_info.php?products_id=64"><img src="images/064.jpg" tppabs="http://osc3.template-help.com/osc_23506/images/064.jpg" border="0" alt="Product #064" title=" Product #064 " width="145" height="118"></a></div>
									</div>
								</div>
							</div>
						</div>
	  ...
	  <span><a href="product_info.php-products_id=64.htm" tppabs="http://osc3.template-help.com/osc_23506/product_info.php?products_id=64">Product #064</a></span>
	  </td></tr>
                        <tr><td class="price_padd"><span class="productSpecialPrice">$42.00</span></td></tr>
                    </table></td>
  </tr>
</table>
</td>
...
<form name="password_forgotten" action="http://osc3.template-help.com/osc_23506/password_forgotten.php?action=process" method="post">	
    ...
    <td  class="cont_heading_td">I've Forgotten My Password!</td>
  		...
  		<table cellpadding="0" cellspacing="0" border="0" class="content_wrapper1_b">
			...
			<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><img src="images/pixel_trans.gif" tppabs="http://osc3.template-help.com/osc_23506/images/pixel_trans.gif" border="0" alt="" width="100%" height="10"></td>
              </tr>
              <tr>
...
<table cellpadding="0" cellspacing="5" border="0"><tr><td>
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
				<tr><td><a href="login.php.htm" tppabs="http://osc3.template-help.com/osc_23506/login.php"><img src="includes/languages/english/images/buttons/button_back1.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/english/images/buttons/button_back1.gif" border="0" alt="Back" title=" Back " width="58" height="24"></a></td>
                <td align="right"><input type="image" src="includes/languages/english/images/buttons/button_continue.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/english/images/buttons/button_continue.gif" border="0" alt="Continue" title=" Continue "></td></tr>
            </table>
