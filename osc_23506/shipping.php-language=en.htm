...
<tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:148px;">
		<tr><td><b>Currencies:</b><form name="currencies" action="http://osc3.template-help.com/osc_23506/shipping.php" method="get"><select name="currency" onChange="this.form.submit();" class="select"><option value="USD" SELECTED>US Dollar</option><option value="EUR">Euro</option></select><input type="hidden" name="language" value="en"></form></td>
		</tr>
	</table>
											</td>
									...
									<table border="0" cellspacing="0" cellpadding="0" align="center" style="width:107px">
										<tr><td><b>&nbsp;&nbsp;Language:</b><a href="shipping.php-language=en.htm" tppabs="http://osc3.template-help.com/osc_23506/shipping.php?language=en"><img src="includes/languages/english/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/english/images/icon.gif" border="0" alt="English" title=" English " width="24" height="15"></a><img src="images/flag_sep2.gif" tppabs="http://osc3.template-help.com/osc_23506/images/flag_sep2.gif" border="0" alt="" width="1" height="10"  style="margin:0px 8px 0px 8px;"><a href="shipping.php-language=de.htm" tppabs="http://osc3.template-help.com/osc_23506/shipping.php?language=de"><img src="includes/languages/german/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/german/images/icon.gif" border="0" alt="Deutsch" title=" Deutsch " width="24" height="15"></a><img src="images/flag_sep2.gif" tppabs="http://osc3.template-help.com/osc_23506/images/flag_sep2.gif" border="0" alt="" width="1" height="10"  style="margin:0px 8px 0px 8px;"><a href="shipping.php-language=es.htm" tppabs="http://osc3.template-help.com/osc_23506/shipping.php?language=es"><img src="includes/languages/espanol/images/icon.gif" tppabs="http://osc3.template-help.com/osc_23506/includes/languages/espanol/images/icon.gif" border="0" alt="Espa&ntilde;ol" title=" Espa&ntilde;ol " width="24" height="15"></a></td>
										</tr>
									</table>
											</td>
											<td><img src="images/part.gif" tppabs="http://osc3.template-help.com/osc_23506/images/part.gif" border="0" alt="" width="1" height="34"></td>
...
<!-- body_text //-->
  ...
  <tr>
    <td  class="cont_heading_td">Shipping & Returns</td>
  </tr>
</table>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr><td class="main">Put here your Shipping & Returns information.</td></tr>
        </table>
